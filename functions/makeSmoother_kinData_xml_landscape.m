...
function [kinData_xml] = makeSmoother_kinData_xml(kinData_xml)
    ...
    parfor larvae = 1:length(kinData_xml)
        total_frames = length(kinData_xml{larvae}.motorData.raw.corrected.centroidposition);
        frames = 1:total_frames;
        
        %% Head Position
        [kinData_xml{larvae}.motorData.smoothed.headposition] = sgolayfilt(kinData_xml{larvae}.motorData.raw.corrected.headposition, 2, 57); %% Savitsky-Golay Filter
        
        %% Tail Position
        [kinData_xml{larvae}.motorData.smoothed.tailposition] = sgolayfilt(kinData_xml{larvae}.motorData.raw.corrected.tailposition, 2, 57); %% Savitsky-Golay Filter
        
        %% Centroid Position
        [kinData_xml{larvae}.motorData.smoothed.centroidposition] = sgolayfilt(kinData_xml{larvae}.motorData.raw.corrected.centroidposition, 2, 57); %% Savitsky-Golay Filter
        
        %% Midpoint Position 
        [kinData_xml{larvae}.motorData.smoothed.midpointposition] = sgolayfilt(kinData_xml{larvae}.motorData.raw.corrected.midpointposition, 2, 57); %% Savitsky-Golay Filter
...
%         [kinData_xml{larvae}.motorData.smoothed.bodyangle] = filter_timeseries(kinData_xml{larvae}.motorData.raw.bodyangle, 10, 1); %% Averaging Filter
        ...
        for i = 2:total_frames-1;
            if length(intersect(i-1:i+1,frames))==3
                dx2 = (kinData_xml{larvae}.motorData.raw.corrected.headposition(i+1,1) - kinData_xml{larvae}.motorData.raw.corrected.headposition(i-1,1))^2/4;
                dy2 = (kinData_xml{larvae}.motorData.raw.corrected.headposition(i+1,2) - kinData_xml{larvae}.motorData.raw.corrected.headposition(i-1,2))^2/4;
        ...
        for i=2:total_frames-1;
            if length(intersect(i-1:i+1,frames))==3
                dx2=(kinData_xml{larvae}.motorData.raw.corrected.tailposition(i+1,1) - kinData_xml{larvae}.motorData.raw.corrected.tailposition(i-1,1))^2/4;
                dy2=(kinData_xml{larvae}.motorData.raw.corrected.tailposition(i+1,2) - kinData_xml{larvae}.motorData.raw.corrected.tailposition(i-1,2))^2/4;
                speed(i)=fps*sqrt(dx2+dy2);
            end
        end
        speedM=NaN(1,total_frames);
        ...
        for i=2:total_frames-1;
            if length(intersect(i-1:i+1,frames))==3
                dx2=(kinData_xml{larvae}.motorData.raw.corrected.centroidposition(i+1,1) - kinData_xml{larvae}.motorData.raw.corrected.centroidposition(i-1,1))^2/4;
                dy2=(kinData_xml{larvae}.motorData.raw.corrected.centroidposition(i+1,2) - kinData_xml{larvae}.motorData.raw.corrected.centroidposition(i-1,2))^2/4;
                speed(i)=fps*sqrt(dx2+dy2);
            end
        end
        speedM=NaN(1,total_frames);
        ...
        for i=2:total_frames-1;
            if length(intersect(i-1:i+1,frames))==3
                dx2=(kinData_xml{larvae}.motorData.raw.corrected.midpointposition(i+1,1) - kinData_xml{larvae}.motorData.raw.corrected.midpointposition(i-1,1))^2/4;
                dy2=(kinData_xml{larvae}.motorData.raw.corrected.midpointposition(i+1,2) - kinData_xml{larvae}.motorData.raw.corrected.midpointposition(i-1,2))^2/4;
                speed(i)=fps*sqrt(dx2+dy2);
            end
        end
        speedM=NaN(1,total_frames);
